# Pulumi GCP Python Storage Bucket Template
 ...
 importante
 modificar env.sh.template -> env.sh y rellenar con credenciales propias. Luego ejecutar source env.sh para que pulumi acceda a variables de entorno requeridas